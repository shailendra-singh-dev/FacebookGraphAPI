package com.shail.facebookgraphapi;
...
import com.itexico.facebookgraphapi.R;
...
public class DetailAdapter extends ArrayAdapter<String> {
    ...
    public DetailAdapter(Context c, int textViewResourceId,
        ...
        options = new DisplayImageOptions.Builder()
                .showImageOnLoading(R.drawable.com_facebook_button_icon)
                .showImageForEmptyUri(R.drawable.com_facebook_button_icon)
                .showImageOnFail(R.drawable.com_facebook_button_icon).cacheInMemory(true)
